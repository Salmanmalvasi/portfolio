    ...
    <section id="contact" className="border-t border-zinc-800 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-6">
        <motion.div
          ...
          className="rounded-2xl border border-zinc-800 bg-[#0d1117]/70 p-8 md:p-12"
        >
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {links.map((link) => (
              <a
                ...
                rel="noreferrer"
                className="rounded-xl border border-zinc-800 p-4 transition hover:border-primary/40 hover:bg-primary/5"
              >
                <p className="font-mono text-xs uppercase tracking-widest text-secondary">
                  {link.label}
                </p>
                <p className="mt-2 text-sm text-zinc-300">{link.value}</p>
              </a>
            ))}
          </div>
